...
public:
  ...
  enum {
    RuleFile = 0, RuleStat = 1, RuleDef = 2, RuleCall = 3, RuleLet = 4, 
    RuleFor = 5, RuleIf = 6, RuleExpr = 7, RuleCommand = 8, RuleList = 9
  };
  ...
  class  PrintContext : public CommandContext {
  public:
    PrintContext(CommandContext *ctx);
  ...
  class  GotoContext : public CommandContext {
  public:
    GotoContext(CommandContext *ctx);

    antlr4::tree::TerminalNode *GOTO();
    antlr4::tree::TerminalNode *INT();
  };

  class  LenContext : public CommandContext {
  public:
    LenContext(CommandContext *ctx);
  ...
  public:
    ListCommandContext(CommandContext *ctx);

    ListContext *list();
  };

  class  EndContext : public CommandContext {
  public:
    EndContext(CommandContext *ctx);
